...
import org.zhiyi.coursecode.week3.gateway.outbound.netty4.NettyHttpClientWithPool;
...
public class HttpOutboundHandler {
    ...
    private static NettyHttpClientWithPool nettyHttpClient;
    ...
    public HttpOutboundHandler(List<String> backends) {
        synchronized (this){
            ...
            if (null == nettyHttpClient) {
                System.out.println(" nettyHttpClient init");
                nettyHttpClient = new NettyHttpClientWithPool();
            }
        }
    }
